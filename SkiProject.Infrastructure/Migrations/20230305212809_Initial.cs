        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileCreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebCamera = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerNightForAPerson = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaceToStays", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceToStayId = table.Column<int>(type: "int", nullable: false),
                    PriceOfTheReservation = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    PrepaidOfTheReservation = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    LeftToPay = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Name", "WebCamera" },
                values: new object[,]
                {
                    { 1, "Bansko", "https://www.banskoski.com/bg/webcams" },
                    { 2, "Borovets", "https://weather-webcam.eu/borovec-hotel-ela-online-kamea-rila-na-jivo/" },
                    { 3, "Pamporovo", "http://free-webcambg.com/Pamporovo-07-webcam-live-online-camera-ski-tv-Snejanka-kameri-na-jivo-vremeto-weather.htm" },
                    { 4, "Panichishte", "http://free-webcambg.com/Rilski-ezera-02-webcam-live-online-camera-hija-Pionerska-Panichishte-Rila-kameri-na-jivo-vremeto-weather.htm" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_PlaceToStayId",
                table: "Reservations",
